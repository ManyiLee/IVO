...
class SDPipeline():
    def __init__(self, device, mode="ti_sd", fix_seed = True):
        ...
        self.mode = mode
        self.model = StableDiffusionPipeline.from_pretrained("/root/data2/myli/CAS/Text2Image/safe/stable-diffusion-v1-4", use_auth_token=True, torch_dtype=torch.float16).to(device)
